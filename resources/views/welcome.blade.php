...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="font-sans antialiased bg-gray-900 pattern">

   
    <header class="mt-12 bg-gray-800">
        <div class="container px-10 mx-auto">
            <!-- <nav class="flex flex-col py-2 sm:flex-row sm:justify-between sm:items-center">
                <div>
                    <a href="#" class="text-2xl font-semibold text-white hover:text-gray-300">BFEM</a>
                </div>
